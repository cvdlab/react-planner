...
export default function WallFactory(name, info, textures) {
  var wallElement = {
    ...
    renderRectangle: function renderRectangle(element, length) {
      ...
      return element.selected ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("rect", {
        x: "0",
        y: -half_thickness,
        width: length,
        height: thickness,
        ...
        y: -textDistance,
        style: STYLE_TEXT
      }, "B")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("rect", {
        x: "0",
        y: -half_thickness,
        width: length,
        height: thickness,
    ...
    renderPolygon: function renderPolygon(element, length, points) {
      ...
      return element.selected ? /*#__PURE__*/React.createElement("g", null, /*#__PURE__*/React.createElement("polygon", {
        ...
        y: -textDistance,
        style: STYLE_TEXT
      }, "B")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("polygon", {
        points: points.map(function (p) {
          return "".concat(p.x, ",").concat(p.y);
        }).join(' '),
        style: STYLE_RECT
