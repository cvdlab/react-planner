...
exports.angleBetweenTwoVertices = angleBetweenTwoVertices;
...
function _arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; } /** @description Determines the distance between two points
...
function angleBetweenTwoVertices(v1, v2) {
