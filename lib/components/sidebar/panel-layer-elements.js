...
var PanelLayerElement = function (_Component) {
  ...
  _createClass(PanelLayerElement, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if ((0, _immutablediff2.default)(oldElements.lines, newElements.lines).size) return true;
      if ((0, _immutablediff2.default)(oldElements.holes, newElements.holes).size) return true;
      if ((0, _immutablediff2.default)(oldElements.items, newElements.items).size) return true;
    ...
    value: function componentWillReceiveProps(nextProps) {
      ...
      if ((0, _immutablediff2.default)(this.props.layers, nextProps.layers).size === 0) return;
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'td',
                  null,
                  _react2.default.createElement(_search2.default, { style: searchIconStyle })
                ),
                _react2.default.createElement(
                  'td',
                  null,
