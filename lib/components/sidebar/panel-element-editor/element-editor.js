...
var ElementEditor = function (_Component) {
  ...
  _createClass(ElementEditor, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if ((0, _immutablediff2.default)(oldAttribute, newAttribute).size) return true;
      if ((0, _immutablediff2.default)(oldProperties, newProperties).size) return true;

      if ((0, _immutablediff2.default)(this.props.state.clipboardProperties, nextProps.state.clipboardProperties).size) return true;
    ...
    value: function componentWillReceiveProps(_ref) {
      ...
      if ((0, _immutablediff2.default)(selectedLayer, layer).size) this.setState({
              ...
              case 'offsetA':
                {
                  ...
                  var offsetAttribute = new _immutable.Map({
                    ...
                    _length: math.toFixedFloat((0, _convertUnits2.default)(lengthValue).from(this.context.catalog.unit).to(value.get('_unit')), PRECISION)
                  });
              ...
              case 'offsetB':
                {
                  ...
                  var _offsetAttribute = new _immutable.Map({
                    ...
                    _unit: value.get('_unit'),
                    _length: math.toFixedFloat((0, _convertUnits2.default)(_lengthValue).from(this.context.catalog.unit).to(value.get('_unit')), PRECISION)
                  });
