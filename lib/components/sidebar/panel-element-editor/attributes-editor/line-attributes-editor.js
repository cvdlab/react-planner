      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(_export.FormNumberInput, { value: vertexOne.get('x'),
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(_export.FormNumberInput, { value: vertexOne.get('y'),
              onChange: function onChange(event) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(_export.FormNumberInput, { value: vertexTwo.get('x'),
              onChange: function onChange(event) {
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'td',
            null,
            _react2.default.createElement(_export.FormNumberInput, { value: vertexTwo.get('y'),
              onChange: function onChange(event) {
