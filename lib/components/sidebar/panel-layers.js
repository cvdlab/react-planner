...
var PanelLayers = function (_Component) {
  ...
  _createClass(PanelLayers, [{
    ...
    value: function shouldComponentUpdate(nextProps, nextState) {
      ...
      if ((0, _immutablediff2.default)(this.props.state.sceneHistory, nextProps.state.sceneHistory).size) return true;
      if (nextState.layerAddUIVisible != this.state.layerAddUIVisible) return true;
      if ((0, _immutablediff2.default)(this.state.editingLayer, nextState.editingLayer).size) return true;
