...
var _ColladaExporter = require('three/examples/js/exporters/ColladaExporter');

var _ColladaExporter2 = _interopRequireDefault(_ColladaExporter);
...
function ToolbarExportButton(_ref, _ref2) {
  ...
  var saveProjectToFile = function saveProjectToFile(e) {
    ...
    setTimeout(function () {
      var exporter = new _ColladaExporter2.default();
