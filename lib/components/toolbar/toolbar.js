...
var _toolbarScreenshotButton = require('./toolbar-screenshot-button');

var _toolbarScreenshotButton2 = _interopRequireDefault(_toolbarScreenshotButton);
...
function Toolbar(_ref, _ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _reactIf2.default,
      { condition: [_constants.MODE_3D_FIRST_PERSON, _constants.MODE_3D_VIEW].includes(mode) },
      _react2.default.createElement(_toolbarScreenshotButton2.default, { state: state })
    ),
