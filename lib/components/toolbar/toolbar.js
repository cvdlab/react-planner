...
var _table = require('react-icons/lib/fa/table');
...
var _toolbarButton = require('./toolbar-button.jsx');
...
function Toolbar(_ref, _ref2) {
  ...
  var volumesActions = _ref2.volumesActions;
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      _toolbarButton2.default,
      { active: [_constants.MODE_VOLUMES_SUMMARY].includes(mode), tooltip: 'Volumes summary',
        onClick: function onClick(event) {
          return volumesActions.selectToolVolumesSummary();
        } },
    ...
    _react2.default.createElement(
      _toolbarButton2.default,
      { active: [_constants.MODE_FITTING_IMAGE, _constants.MODE_UPLOADING_IMAGE].includes(mode), tooltip: 'Upload image',
        onClick: function onClick(event) {
          return imagesActions.selectToolUploadImage();
        } },
...
Toolbar.contextTypes = {
  ...
  volumesActions: _react.PropTypes.object.isRequired,
