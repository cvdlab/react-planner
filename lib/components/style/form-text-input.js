...
var FormTextInput = /*#__PURE__*/function (_Component) {
  ...
  _createClass(FormTextInput, [{
    ...
    value: function render() {
      ...
      var textInputStyle = _objectSpread(_objectSpread({}, STYLE_INPUT), style);
      if (this.state.focus) textInputStyle.border = "1px solid ".concat(SharedStyle.SECONDARY_COLOR.main);
