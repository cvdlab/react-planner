...
var Planner = function (_Component) {
  ...
  _createClass(Planner, [{
    ...
    value: function componentWillMount() {
      ...
      var customReducer = _state.customReducer;
      var actionsExtraArgument = _state.actionsExtraArgument;
      var onReady = _state.onReady;
    ...
    value: function render() {
      ...
      var toolbarButtons = _state2.toolbarButtons;
      var customContents = _state2.customContents;
      var customActions = _state2.customActions;
