...
var Viewer3DFirstPerson = function (_React$Component) {
  ...
  function Viewer3DFirstPerson(props) {
    ...
    _this.renderer = window.__threeRenderer || new _three2.default.WebGLRenderer();
  ...
  _createClass(Viewer3DFirstPerson, [{
    ...
    value: function componentDidMount() {
      ...
      //RENDERER
      this.renderer.setClearColor(new _three2.default.Color(0xffffff));
      ...
      var controls = _initPointerLock.controls;
      var pointerlockChangeEvent = _initPointerLock.pointerlockChangeEvent;
      var requestPointerLockEvent = _initPointerLock.requestPointerLockEvent;
