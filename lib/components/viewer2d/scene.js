  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      layers.entrySeq().filter(function (_ref2) {
        ...
        var layerID = _ref5[0];
        var layer = _ref5[1];
        return _react2.default.createElement(_layer2.default, { key: layerID, layer: layer, mode: mode, scene: scene });
      })
    ),
    _react2.default.createElement(_layer2.default, { key: selectedLayer.id, layer: selectedLayer, mode: mode, scene: scene })
  );
}
