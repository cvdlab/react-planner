...
function Line(_ref, _ref2) {
  ...
  var renderedHoles = line.holes.map(function (holeID) {
    ...
    var startAt = length * hole.offset - hole.properties.get('width') / 2;
    var renderedHole = catalog.getElement(hole.type).render2D(hole, layer);
  ...
  var renderedRuler = line.selected ? _react2.default.createElement(_ruler2.default, { pixelPerUnit: pixelPerUnit, unit: unit, length: length, transform: 'translate(0, 15)' }) : null;
