...
function Layer(_ref) {
  ...
  return _react2.default.createElement(
    'g',
    null,
    images.entrySeq().map(function (_ref2) {
      var _ref3 = _slicedToArray(_ref2, 2);

      var imageID = _ref3[0];
      var image = _ref3[1];
      return _react2.default.createElement(_image2.default, { key: imageID, layer: layer, image: image, mode: mode });
    }),
    areas.entrySeq().map(function (_ref4) {
    ...
    lines.entrySeq().map(function (_ref6) {
    ...
    items.entrySeq().map(function (_ref8) {
    ...
    vertices.entrySeq().filter(function (_ref10) {
