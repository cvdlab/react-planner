...
var HistoryStructure = /*#__PURE__*/function (_Record13) {
  ...
  function HistoryStructure() {
    ...
    return _super13.call(this, {
      undoList: (0, _immutable.fromJS)(json.undoList || []),
      redoList: (0, _immutable.fromJS)(json.redoList || []),
  ...
  undoList: new _immutable.List(),
  redoList: new _immutable.List(),
  first: null,
  last: null
}, 'HistoryStructure'));
