...
var _volumesReducer = require('./volumes-reducer');

var _volumesReducer2 = _interopRequireDefault(_volumesReducer);
...
var _imagesReducer = require('./images-reducer');
...
function appReducers(state, action) {
  ...
  switch (action.type) {
    ...
    case constants.END_FITTING_IMAGE:
      return (0, _imagesReducer2.default)(state, action);
    ...
    case constants.SELECT_TOOL_VOLUMES_SUMMARY:
      return (0, _volumesReducer2.default)(state, action);
