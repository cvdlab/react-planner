...
function updateDraggingLine(state, x, y) {
  ...
  var curSnap0 = (0, _snap.nearestSnap)(snapElements, newVertex0X, newVertex0Y);
  var curSnap1 = (0, _snap.nearestSnap)(snapElements, newVertex1X, newVertex1Y);
  ...
  return state.withMutations(function (state) {
    var scene = state.scene.updateIn(['layers', layerID], function (layer) {
      return layer.withMutations(function (layer) {
        ...
        (0, _layerOperations.removeLine)(layer, lineID);
        (0, _layerOperations.addLineAvoidingIntersections)(layer, line.type, newVertex0X, newVertex0Y, newVertex1X, newVertex1Y, catalog);
        (0, _layerOperations.detectAndUpdateAreas)(layer, catalog);
      });
    });
