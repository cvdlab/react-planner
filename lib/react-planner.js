...
var _overlays = _interopRequireDefault(require("./components/overlays"));
...
function ReactPlannerContent(props) {
  ...
  }, /*#__PURE__*/_react["default"].createElement(_overlays["default"], _extends({
    width: width,
    height: contentH,
    state: extractedState
  }, otherProps)), /*#__PURE__*/_react["default"].createElement(Toolbar, _extends({
    state: extractedState
...
ReactPlannerContent.propTypes = {
  ...
  customActions: _propTypes["default"].object,
