...
var Catalog = function () {
  function Catalog() {
    ...
    this.registerPropertyType('hidden', _propertyHidden2.default, _propertyHidden2.default);
    this.registerPropertyType('read-only', _propertyReadOnly2.default, _propertyReadOnly2.default);
  }
