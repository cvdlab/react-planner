...
const logoImage = textureLoader.load(require('./logo.jpg'));

let objectMaxLODJSON = makeObjectMaxLOD().toJSON();
let objectMinLODJSON = makeObjectMinLOD().toJSON();

function makeObjectMaxLOD() {

  let steelTexture =  new Three.MeshLambertMaterial({});
  let darkSteelTexture =  new Three.MeshLambertMaterial({});
  let logoTexture =  new Three.MeshLambertMaterial({});
...
function makeObjectMinLOD() {
  ...
  let logoTexture =  new Three.MeshLambertMaterial({map:logoImage});
...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    let objectMaxLOD = loader.parse(objectMaxLODJSON);
    let objectMinLOD = makeObjectMinLOD();

    /************ lod max ****************/

    let kitchenMaxLOD=new Three.Object3D();
    kitchenMaxLOD.add(objectMaxLOD);
    ...
    kitchenMinLOD.add(objectMinLOD);
