...
export default {
  ...
  render3D: function (element, layer, scene) {
    ...
    //colors
      ...
      let fermo = new Three.Mesh(bodyGeometry2, black);
      ...
      let bocchetta_p1 = new Three.Mesh(cylinderGeometry, black);
      ...
      let bocchetta_p2 = new Three.Mesh(cylinderGeometry1, grey);
      ...
      let indicatoreImage = textureLoader.load(require('./estintoreIndicatore.png'));

      let geometry2 = new Three.PlaneGeometry(0.04, 0.04);
      let material2 = new Three.MeshLambertMaterial({map: indicatoreImage, transparent: true});
      let indicatore = new Three.Mesh(geometry2, material2);
      ...
      let etichettaImage = textureLoader.load(require('./etichettaEstintore.png'));
      ...
      let valvola_p1 = new Three.Mesh(geometry4, material4);
      ...
      let valvola_p2 = new Three.Mesh(geometry5, red);
      ...
      let sicura_p1 = new Three.Mesh(geometry6, yellow);
      ...
      let sicura_p2 = new Three.Mesh(cylinderGeometry8, yellow);
