...
In this example, we'll create a GenericToolbarButtion:
...
import { ReactPlannerComponents, ReactPlannerContext, ReactPlannerConstants } from 'react-planner';

// Example of mode usage
const { MODE_IDLE, MODE_3D_VIEW } = ReactPlannerConstants;

// Toolbar button class usage
